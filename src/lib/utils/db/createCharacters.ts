...
export async function createCharacters(players: any[]) {
  const characters = await Character.create([
    // First campaign characters
    {
      ...
      race: 'High Elf',
      imageUrl: 'https://i.ibb.co/HF1KV7P/character.png',
      background: 'Sage',
      alignment: 'NG',
      experience: 6500,
      stats: {
    ...
    },
    {
      ...
      race: 'Mountain Dwarf',
      imageUrl: 'https://i.ibb.co/88BTg0L/character.png',
      background: 'Soldier',
      alignment: 'LG',
      experience: 6500,
      stats: {
    ...
    },
    {
      ...
      race: 'Halfling',
      imageUrl: 'https://i.ibb.co/ZS5KrW7/character.png',
      background: 'Criminal',
      alignment: 'CN',
      experience: 6500,
      stats: {
    ...
    // Second campaign characters
    {
      ...
      race: 'Tiefling',
      imageUrl: 'https://i.ibb.co/C1cpDTq/character.png',
      background: 'Noble',
      alignment: 'LN',
      experience: 2700,
      stats: {
    ...
    },
    {
      ...
      race: 'Human',
      imageUrl: 'https://i.ibb.co/N3JLH3N/character.png',
      background: 'Acolyte',
      alignment: 'LG',
      experience: 2700,
      stats: {
    ...
    },
    {
      ...
      race: 'Wood Elf',
      imageUrl: 'https://i.ibb.co/CPDHHyR/character.png',
