...
export async function createCharacters(players: any[]) {
  const characters = await Character.create([
    // First campaign characters
    {
      ...
      race: 'High Elf',
      imageUrl: 'https://i.ibb.co/f1BX2MN/character.png',
      background: 'Sage',
      alignment: 'NG',
      experience: 6500,
      stats: {
    ...
    },
    {
      ...
      race: 'Mountain Dwarf',
      imageUrl: 'https://i.ibb.co/RHSZT9k/character.png',
      background: 'Soldier',
      alignment: 'LG',
      experience: 6500,
      stats: {
    ...
    },
    {
      ...
      race: 'Halfling',
      imageUrl: 'https://i.ibb.co/nB9fyzt/character.png',
      background: 'Criminal',
      alignment: 'CN',
      experience: 6500,
      stats: {
    ...
    // Second campaign characters
    {
      ...
      race: 'Tiefling',
      imageUrl: 'https://i.ibb.co/smfpzMh/warlock.png',
      background: 'Noble',
      alignment: 'LN',
      experience: 2700,
      stats: {
    ...
    },
    {
      ...
      race: 'Human',
      imageUrl: 'https://i.ibb.co/SxMK9xm/paladin.png',
      background: 'Acolyte',
      alignment: 'LG',
      experience: 2700,
      stats: {
    ...
    },
    {
      ...
      race: 'Wood Elf',
      imageUrl: 'https://i.ibb.co/sWzVV48/druid.png',
