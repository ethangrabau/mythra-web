...
export async function createCharacters(players: any[]) {
  const characters = await Character.create([
    // First campaign characters
    {
      ...
      race: 'High Elf',
      imageUrl: 'https://i.bb.co/HF1KV7P/character.jpg',
      background: 'Sage',
      alignment: 'NG',
      experience: 6500,
      stats: {
    ...
    },
    {
      ...
      race: 'Mountain Dwarf',
      imageUrl: 'https://i.bb.co/88BTg0L/character.jpg',
      background: 'Soldier',
      alignment: 'LG',
      experience: 6500,
      stats: {
    ...
    },
    {
      ...
      race: 'Halfling',
      imageUrl: 'https://i.bb.co/ZS5KrW7/character.jpg',
      background: 'Criminal',
      alignment: 'CN',
      experience: 6500,
      stats: {
    ...
    // Second campaign characters
    {
      ...
      race: 'Tiefling',
      imageUrl: 'https://i.bb.co/C1cpDTq/character.jpg',
      background: 'Noble',
      alignment: 'LN',
      experience: 2700,
      stats: {
    ...
    },
    {
      ...
      race: 'Human',
      imageUrl: 'https://i.bb.co/N3JLH3N/character.jpg',
      background: 'Acolyte',
      alignment: 'LG',
      experience: 2700,
      stats: {
    ...
    },
    {
      ...
      race: 'Wood Elf',
      imageUrl: 'https://i.bb.co/CPDHHyR/character.jpg',
