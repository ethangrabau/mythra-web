...
export async function createLocations(campaigns: any[], quests: any[]) {
  const locations = await Location.create([
    ...
    },
    {
      ...
      isDiscovered: false,
      isRestricted: true,
      imageUrl: 'https://i.ibb.co/VD26Jhs/location.png',
    ...
    },
    {
      ...
      type: 'city',
      imageUrl: 'https://i.ibb.co/tK790FS/location.png',
      isDiscovered: true,
      isRestricted: false,
    ...
    },
    {
      ...
      type: 'dungeon',
      imageUrl: 'https://i.ibb.co/NL4shjT/location.png',
      isDiscovered: false,
      isRestricted: true,
    ...
    },
    {
      ...
      type: 'dungeon',
      imageUrl: 'https://i.ibb.co/zST0DNb/location.png',
      isDiscovered: false,
      isRestricted: true,
    ...
    },
    {
      ...
      type: 'wilderness',
      imageUrl: 'https://i.ibb.co/SK8ZL7V/location.png',
      isDiscovered: false,
      isRestricted: false,
      campaigns: [],
      quests: [],
    ...
    },
    {
      ...
      type: 'fortress',
      imageUrl: 'https://i.ibb.co/TtTWCDF/location.png',
      isDiscovered: true,
      isRestricted: true,
