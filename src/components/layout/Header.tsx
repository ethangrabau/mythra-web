      ...
      <div className='flex items-center justify-between h-16 px-8'>
        ...
        {isRecording ? (
          <button
            ...
            className='px-4 py-2 text-sm font-medium text-white bg-red-600 rounded-md hover:bg-red-700 shadow-sm hover:shadow transition-all flex items-center gap-2'>
          ...
          <button
            ...
            className='px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700 shadow-sm hover:shadow transition-all flex items-center gap-2'>
