...
export default function Sidebar() {
  ...
  return (
    <aside className='w-64 border-r h-screen bg-background shadow-sm'>
      <div className='p-4'>
        ...
        <div className='space-y-6'>
          <div className='p-6 rounded-xl border shadow-sm hover:shadow-md transition-all duration-200'>
            <h3 className='text-sm font-medium mb-3 text-foreground'>Recording Status</h3>
            ...
            {!isConnected && <p className='text-sm text-yellow-600 mb-3'>Connecting to server...</p>}
            ...
            <button
              ...
              `}>
              <Mic
                className={`w-4 h-4 group-hover:scale-110 transition-transform ${isRecording ? 'animate-pulse' : ''}`}
              />
          ...
          <div className='p-6 rounded-xl border shadow-sm hover:shadow-md transition-all duration-200'>
            <h3 className='text-sm font-medium mb-3 text-foreground'>Image Generation</h3>
            <button
